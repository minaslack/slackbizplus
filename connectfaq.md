...
본 가이드로 해결이 되지 않는 부분은 <strong>/feedback</strong> 또는 <strong>feedback@slack.com</strong>을 통하여 Slack 피드백팀의 지원을 받으시는 것을 권장드립니다.<br>
  ...
  <label for="f1" class="focus-card">
    ...
    <div class="solution-area">
      <div class="sol-box">
        ...
        <br>
        <strong>* 기본 원칙:</strong> Slack Connect는 <strong>유료 플랜 워크스페이스 간</strong>에만 연결 가능 <strong>(무료 플랜은 사용 불가)</strong><br>
        <strong>* 예외 조건:</strong> 초대를 보내는 측이 <strong>Ent+플랜</strong>이며 조직 내에서 허용된 경우, <strong>무료 워크스페이스와도 연결 가능</strong><br>
      </div>
    </div>
  </label>
</div>
...
<div class="grid-item cat-invite">
  ...
  <label for="f2" class="focus-card">
    ...
    <div class="solution-area">
      <div class="sol-box">
        하나의 채널에는 <b>최대 250개의 조직</b>까지만 연결할 수 있습니다.<br>
        250개를 초과할 경우 더 이상 새로운 조직을 추가할 수 없습니다.
      </div>
    </div>
  </label>
</div>
...
<div class="grid-item cat-timeout">
  ...
  <label for="f4" class="focus-card">
    ...
    <div class="solution-area">
      <div class="sol-box">
        <div style="font-weight: bold; color: #4D5656; background: #F2F4F4; padding: 2px 6px; border-radius: 8px; width: fit-content; font-size: 11px; margin-bottom: 8px;">원인</div>
        <b>'포스트만 가능'한 권한을 가진 채널</b>에서 초대 링크를 생성한 뒤, 다른 멤버가 <b>해당 링크를 통해 초대를 수락하는 경우</b> 발생합니다.<br><br>
        <div style="font-weight: bold; color: #4D5656; background: #F2F4F4; padding: 2px 6px; border-radius: 8px; width: fit-content; font-size: 11px; margin-bottom: 8px;">해결책</div>
  ...
  <label for="f8" class="focus-card">
    ...
    <div class="hint-text"></div>
      ...
      <div class="sol-box">
        ...
        * 초대자 : 조직 1의 사용자 X가 채널을 만들고 조직 2(Ent+플랜)의 A와 B를 동시에 초대함<br>
        * 수락자 A : 조직 2의 [워크스페이스 AA] 소속 -> 초대를 먼저 수락함<br>
         - 결과: 이제 이 채널은 [조직 1]과 조직 2의 [워크스페이스 AA]를 잇는 다리가 됨<br>
        * 수락자 B: 조직 2의 [워크스페이스 BB] 소속 -> 연결 실패<br>
         - 이유: 채널이 [워크스페이스 AA]와 연결되어 버렸는데, 정작 B는 AA의 멤버가 아니기 때문에 해당 채널에 접근할 권한이 없음<br>
        <div style="font-weight: bold; color: #4D5656; background: #F2F4F4; padding: 2px 6px; border-radius: 8px; width: fit-content; font-size: 11px; margin-bottom: 8px;">해결책</div>
        * 방법 1 (채널 수정): 조직 2 관리자가 해당 채널을 AA와 BB 모두 접근할 수 있는 '멀티 워크스페이스 채널'로 설정 변경(권장)<br>
        * 방법 2 (사용자 이동): 조직 2 관리자가 User B를 [워크스페이스 AA]의 멤버로 추가<br><br>
</div>
    </div>
  </label>
</div>
