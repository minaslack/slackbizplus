...
<details style="margin-bottom: 8px; border: 1px solid #e1e4e8; border-radius: 8px; overflow: hidden;">
  <summary style="padding: 12px; cursor: pointer; background: #FFFFFF; font-weight: 700; color: #24292e; display: list-item; border-radius: 8px 8px 0 0;">
      <div style="display: inline-flex; align-items: center; gap: 10px; vertical-align: middle;">
          <img height="32" alt="image" src="https://github.com/user-attachments/assets/1da3aa4f-adf1-42de-8cfc-8457f2d0d9f1" /> 
